...
const DUMMY_DATA = [
    // --- 맛집/방문 ---
    {
        ...
        category: "맛집", thumbnail_url: "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=800&q=80",
    ...
    },
    {
        ...
        category: "맛집", thumbnail_url: "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=800&q=80",
    ...
    },
    {
        ...
        category: "맛집", thumbnail_url: "https://images.unsplash.com/photo-1544025162-d76694265947?w=800&q=80",
    ...
    // --- 뷰티/건강 ---
    {
        ...
        category: "뷰티", thumbnail_url: "https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=800&q=80",
    ...
    },
    {
        ...
        category: "뷰티", thumbnail_url: "https://images.unsplash.com/photo-1526947425960-945c6e72858f?w=800&q=80",
    ...
    },
    {
        ...
        category: "뷰티", thumbnail_url: "https://images.unsplash.com/photo-1481343160114-61014cc62bc6?w=800&q=80",
    ...
    // --- IT/생활 ---
    {
        ...
        category: "IT/가전", thumbnail_url: "https://images.unsplash.com/photo-1511467687858-23d96c32e4ae?w=800&q=80",
    ...
    },
    {
        ...
        category: "생활", thumbnail_url: "https://images.unsplash.com/photo-1504280390367-361c6d9f38f4?w=800&q=80",
    ...
    },
    {
        ...
        category: "IT/가전", thumbnail_url: "https://images.unsplash.com/photo-1625514523025-69680327f1c1?w=800&q=80",
    ...
    // --- 패션 ---
    {
        ...
        category: "패션", thumbnail_url: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&q=80",
    ...
    },
    {
        ...
        category: "패션", thumbnail_url: "https://images.unsplash.com/photo-1544816155-12df9643f363?w=800&q=80",
    ...
    // --- 반려동물 ---
    {
        ...
        category: "반려동물", thumbnail_url: "https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=800&q=80",
    ...
    // --- 기타/서비스 ---
    {
        ...
        category: "기타", thumbnail_url: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=800&q=80",
    ...
    },
    {
        ...
        category: "기타", thumbnail_url: "https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=800&q=80",
    ...
    },
    {
        ...
        recruit_count: 30, recruitment_start_date: daysFromNow(-1), end_date: daysFromNow(15),
        category: "맛집", thumbnail_url: "https://images.unsplash.com/photo-1542838132-92c53300491e?w=800&q=80",
    ...
    },
    {
        ...
        category: "기타", thumbnail_url: "https://images.unsplash.com/photo-1520340356584-f9917d1eea6f?w=800&q=80",
    ...
    },
    {
        ...
        category: "생활", thumbnail_url: "https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=800&q=80",
    ...
    },
    {
        ...
        category: "여행", thumbnail_url: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&q=80",
    ...
    },
    {
        ...
        category: "생활", thumbnail_url: "https://images.unsplash.com/photo-1550009158-9ebf69173e03?w=800&q=80",
    ...
    },
    {
        ...
        category: "뷰티", thumbnail_url: "https://images.unsplash.com/photo-1512290923902-8a9f81dc2069?w=800&q=80",
...
async function seed() {
    ...
    console.log(`🌱 Inserting 20 diverse dummy campaigns for ${ADVERTISER_ID}...`);
    ...
    console.log("✨ Seeding of 20 diverse campaigns completed!");
}
