...
export default function GuidePage() {
    ...
    return (
        <div className="bg-white">
            {/* Header */}
            <div className="bg-rose-50 border border-rose-100 rounded-xl py-12 text-center mb-8">
                <h1 className="text-3xl font-extrabold text-text-main mb-3">다온뷰 이용 가이드</h1>
                <p className="text-text-secondary">누구나 쉽게 시작하는 인플루언서 라이프, 다온뷰와 함께하세요.</p>
            </div>

            {/* Steps */}
            <div className="bg-white rounded-2xl shadow-lg shadow-slate-200/60 p-8 border border-slate-100">
            ...
            <div className="mt-16 text-center">
                ...
                <div className="flex justify-center gap-4">
                    <Link href="/community/faq" className="btn btn-primary px-8 py-3 rounded-full text-lg">
                        자주 묻는 질문 보러가기
                    </Link>
