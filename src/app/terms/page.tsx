                ...
                <div className="bg-white rounded-2xl border border-border p-8 md:p-12 shadow-sm">
                    <div className="prose max-w-none">
                        ...
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제1장 총칙</h2>
                            
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제1조 (목적)</h3>
                            ...
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제2조 (정의)</h3>
                            ...
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제3조 (약관의 효력 및 변경)</h3>
                                <p className="text-text-secondary leading-relaxed mb-4">
                        ...
                        {/* 제2장 서비스 이용계약 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제2장 서비스 이용계약</h2>
                            
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제4조 (이용계약의 성립)</h3>
                                <p className="text-text-secondary leading-relaxed mb-4">
                            ...
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제5조 (회원정보의 변경)</h3>
                                <p className="text-text-secondary leading-relaxed mb-4">
                        ...
                        {/* 제3장 서비스 이용 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제3장 서비스 이용</h2>
                            
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제6조 (서비스의 제공)</h3>
                                <p className="text-text-secondary leading-relaxed mb-4">
                            ...
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제7조 (서비스의 중단)</h3>
                                <p className="text-text-secondary leading-relaxed mb-4">
                            ...
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제8조 (회원의 의무)</h3>
                                <p className="text-text-secondary leading-relaxed mb-4">
                        ...
                        {/* 제4장 계약해지 및 이용제한 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제4장 계약해지 및 이용제한</h2>
                            
                            <div className="mb-8">
                                <h3 className="text-xl font-bold text-text-main mb-3">제9조 (계약해지 및 이용제한)</h3>
                                <p className="text-text-secondary leading-relaxed mb-4">
                        ...
                        <section className="mb-8">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">부칙</h2>
                        ...
                        <div className="mt-12 p-6 bg-rose-50 rounded-2xl border border-rose-100">
                            <h3 className="text-lg font-bold text-text-main mb-3">문의사항</h3>
                            <p className="text-text-secondary mb-2">
                                본 약관에 대한 문의사항이 있으시면 아래로 연락 주시기 바랍니다.
                            </p>
                            <div className="space-y-1 text-sm text-text-secondary">
                                <p><strong>회사명:</strong> 다온컴퍼니</p>
                                <p><strong>대표자:</strong> 신지호</p>
