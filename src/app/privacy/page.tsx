            ...
            <div className="container py-16">
                ...
                <div className="bg-white rounded-2xl border border-border p-8 md:p-12 shadow-sm">
                    <div className="prose max-w-none">
                        ...
                        {/* 제1조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제1조 (개인정보의 처리 목적)</h2>
                        ...
                        {/* 제2조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제2조 (개인정보의 처리 및 보유기간)</h2>
                        ...
                        {/* 제3조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제3조 (처리하는 개인정보의 항목)</h2>
                        ...
                        {/* 제4조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제4조 (개인정보의 제3자 제공)</h2>
                        ...
                        {/* 제5조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제5조 (개인정보의 파기)</h2>
                        ...
                        {/* 제6조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제6조 (정보주체의 권리·의무 및 행사방법)</h2>
                        ...
                        {/* 제7조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제7조 (개인정보 보호책임자)</h2>
                        ...
                        {/* 제8조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제8조 (개인정보의 안전성 확보조치)</h2>
                        ...
                        {/* 제9조 */}
                        <section className="mb-12">
                            <h2 className="text-2xl font-bold text-text-main mb-6 pb-3 border-b-2 border-primary">제9조 (개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</h2>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-text-secondary leading-relaxed mb-2">
                                <strong>시행일자:</strong> 본 방침은 2024년 1월 1일부터 시행됩니다.
                            </p>
                            <p className="text-text-secondary leading-relaxed">
                        ...
                        <div className="mt-12 p-6 bg-rose-50 rounded-2xl border border-rose-100">
                            <h3 className="text-lg font-bold text-text-main mb-3">개인정보 관련 문의</h3>
