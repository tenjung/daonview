...
const CampaignSkeleton = ({ variant = 'default', density = 'default' }: CampaignSkeletonProps) => (
    <div className="border border-gray-100 rounded-xl overflow-hidden bg-white h-full shadow-sm">
        <div className={`${density === 'compact' ? 'aspect-[1.58/1] lg:aspect-[4/3]' : 'aspect-[4/3]'} bg-rose-50/50 animate-pulse relative`}>
        ...
        <div className={`${density === 'compact' ? 'p-2 lg:p-5 space-y-2 lg:space-y-3' : 'p-5 space-y-3'}`}>
